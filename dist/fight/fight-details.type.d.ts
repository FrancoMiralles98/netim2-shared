...
export type FightMetric = 'ad_realizado' | 'ap_realizado' | 'critico_realizado' | 'penetracion_realizado' | 'ataque_basico_realizado' | 'curacion_cortada' | 'reflejo_realizado' | 'ataques_bloqueados' | 'ataques_esquivados' | `${FightEffectId}_realizado` | `${FightEffectId}_aplicado`;
